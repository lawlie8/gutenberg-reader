...
export const END_GET_AUTH_SIGNUP = BASE_URL + '/web/signup';
export const GET_DAILY_RSS_BOOK_DATA = BASE_URL + '/app/rss/book/daily'
export const END_GET_AUTH_LOGOUT = BASE_URL + '/web/logout';
...
export const CHECK_IF_USER_IS_VALID = BASE_URL + '/web/user/check/'
